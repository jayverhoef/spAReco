...
<<Fig-Neighbors, fig.width=12, fig.height=12, echo= FALSE, include = FALSE, cache = TRUE>>=
  ...
  par(mar = c(0,1,5,1))
  plot(pvpolys2)
  lines(c(xleft - xexp, xright + xexp), c(ybottom - yexp, ybottom - yexp), lwd = 3, col = 'red')
  lines(c(xleft - xexp, xright + xexp), c(ytop + yexp, ytop + yexp), lwd = 3, col = 'red')
  lines(c(xleft - xexp, xleft - xexp), c(ybottom - yexp, ytop + yexp), lwd = 3, col = 'red')
  lines(c(xright + xexp, xright + xexp), c(ybottom - yexp, ytop + yexp), lwd = 3, col = 'red')
...
colBayes = '#e7298a'
par(mar = c(5,5,1,5))
plot(-1 + exp(prolik1[,1])/(1+exp(prolik1[,1]))*2,prolik1[,2], type = 'l',
  col = colCAR1, xlab = 'Rho', ylab = '2*log-likelihood', ylim = c(400,412), 
  lwd = 4, cex.lab = 2, cex.axis = 1.5, xlim = c(-1,1))
lines(-1 + exp(prolik2[,1])/(1+exp(prolik2[,1]))*2,prolik2[,2], col = colCAR2, lwd = 4)
lines(-1 + exp(prolik4[,1])/(1+exp(prolik4[,1]))*2,prolik4[,2],col = colCAR4, lwd = 4)
lines(c(-1,1), rep(-sparXCAR4rs$m2LL - 3.84, times = 2), lty = 2, col = colCAR4, lwd = 4)
legend(-1,412, lty = c(1,1,1,1), lwd = rep(4, times =4), col = c(colCAR1, colCAR2, colCAR4, colBayes),
   legend = c('XC1R-mle', 'XC2R-mle', 'XC4R-mle','XC4R-mcmc'))
par(new = TRUE)
plot(density(rho, bw = .05), type = 'l', axes = FALSE, bty = 'n', 
  main = '', xlab = '', ylab = '', col = colBayes, lwd = 4, xlim = c(-1,1))
...
<<Fig-MargVar, echo= FALSE, fig.height = 10, fig.width = 8, include = FALSE, cache = TRUE>>=
  ...
  plot(apply(Nmat4,1,sum)-.1, diag(solve(sparXCAR4rs$Vi)), pch = 19, col = colrs,
     ...
     cex = 1.0, cex.axis = 1.5)
  points(apply(Nmat4,1,sum)+.1, diag(solve(sparXCAR4$Vi)), pch = 19, 
     cex = 1.0, col = colun)
  ...
  points(0.9,mean(cN1rs), pch = 19, col = colrs, cex = 3) 
  points(1.9,mean(cN2rs), pch = 19, col = colrs, cex = 3) 
  points(2.9,mean(cN3rs), pch = 19, col = colrs, cex = 3) 
  points(3.9,mean(cN4rs), pch = 19, col = colrs, cex = 3) 
  cN = rbind(
  ...
  points(1.1,mean(cN1), pch = 19, col = colun, cex = 3) 
  points(2.1,mean(cN2), pch = 19, col = colun, cex = 3) 
  points(3.1,mean(cN3), pch = 19, col = colun, cex = 3) 
  points(4.1,mean(cN4), pch = 19, col = colun, cex = 3) 
